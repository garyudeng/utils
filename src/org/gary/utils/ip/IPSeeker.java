...
public class IPSeeker {
    ...
    static{
    	...
    	IP_FILE=path.replace("file:/", "").replace("classes/", "").replace("%20", " ")+"QQWry.Dat";
    }
    public IPSeeker( )  {  
        ...
        try {  
            ipFile = new RandomAccessFile(IP_FILE, "r");  
        	 ...
        	 System.out.println("IP地址信息文件没有找到，IP显示功能将无法使用!" + e);  
        }   
        // 如果打开文件成功，读取文件头信息  
        if(ipFile != null) {  
            try {  
            	...
            	System.out.println("IP地址信息文件格式有错误，IP显示功能将无法使用!" + e);  
                ipFile = null;  
            }             
        }  
    }  
    ...
    /*	 System.out.println(DateUtil.toString(new Date(),"yyMMddHHmmss ssss"  )); 
   	 ...
   	 System.out.println(DateUtil.toString(new Date(),"yyMMddHHmmss ssss"  ));
   	 */
   	 IPLocation iplocation=ip.getIPLocation("61.164.68.58");
   	 System.out.println(iplocation.getArea()+"\t"+iplocation.getCountry());
    }
