...
public class CryptoUtils    {
    ...
    /** 将两个block进行异或 */
    public static void xorBlock( byte[] a, int aOff, byte[] b,
				    int bOff, byte[] dst, int dstOff, int len )	{
    ...
    /** 棄1�7查两个block是否相等 */
    public static boolean equalsBlock( byte[] a, int aOff, byte[] b,
				    int bOff, int len )	{
